...
mainDecl:       STARTMAIN spaces stmtList spaces ENDMAIN;
structDecl:     structDecl spaces struct | struct;
struct:         STRUCT NAME NEWLINE varRepeat spaces ENDSTRUCT
                | TYPEDEF STRUCT NAME NEWLINE varRepeat spaces ENDSTRUCT
                ;
stmtList:       stmtList spaces stmt | stmt | /* empty */;
stmt:           varDecl | expStmt | iterStmt | selectStmt | switch | print | break | TYPE_COMMENT NEWLINE;
